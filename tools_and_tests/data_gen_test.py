...
V.sinusoidal(freq_range=(0.01, 0.05), amp_range=(0, 3), num_modes=4)
V.sinusoidal(freq_range=(0.001, 0.01), amp_range=(3, 7), num_modes=2)
V.affine(grad_range=(-0.1, 0.1), bias_range=(-1, 2))
sdf_mri_circ = SDF_MRI_Circle(V, r = 22.)
sdf_mri_tube = SDF_MRI_Tube(V, r = 10.)
