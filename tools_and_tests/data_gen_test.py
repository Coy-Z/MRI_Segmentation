...
Vc.random_coherent(log_length_scale_mean=-2.3, log_length_scale_variance=0.5, amplitude_variance=40)
Vc.random_coherent(log_length_scale_mean=0, log_length_scale_variance=1, amplitude_variance=30)
Vt.random_coherent(log_length_scale_mean=-2, log_length_scale_variance=0.5, amplitude_variance=10)
Vt.random_coherent(log_length_scale_mean=0, log_length_scale_variance=1, amplitude_variance=40)
